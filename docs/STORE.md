...
• Attach a text file — code, notes, CSV, JSON — and it goes with your question.
...
| Asset | Size | Notes |
|---|---|---|
| Screenshots ×5 | 1280×800 | The store shows the first one largest; lead with the whole page, with the favorites bar in frame |
...
1. The whole page, light — clock, pills, box, real recall rows, favorites
